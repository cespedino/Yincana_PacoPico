...
const Final = () => {
  return (
    <div className="page-content">
      ...
      <p>
        Sin embargo, es trivial demostrar el siguiente corolario a partir del resultado anterior: <br/>
        ...
        Esos pequeños (inmensos) detalles, <br/>
        Las comidas en el dominos, para luego pasar por delante de vitalia.<br/>
        Las vueltas por la noche de las clases de tarde.<br/>
