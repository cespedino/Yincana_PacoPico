...
const Leyenda = () => {
  return (
    <div className='page-content'>
      ...
      <p>
        Antes de esta aventura, Miguel "el bombas", José "el caminante de la pradera", Alberto "la berta", Raúl "el marido deseado con tierras", Angy "la trotamundos" 
      ...
      <p className='acertijos'>
        Si me miras bien parezco una toro, <br/ >
